...
Route::get('/searchExperiencias','Web\PageController@searchExperiencias')->name('searchExperiencias');
Route::get('/searchProductoRubro','Web\PageController@searchProductoRubro')->name('searchProductoRubro');
