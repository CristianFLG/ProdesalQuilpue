...
class CreateExperienciaProductorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('experiencia_productor', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('experiencia_productor');
    }
}
